...
settings.auth.hmac_key = "5d53dfec-a823-4788-8011-895f057b9942"
...
# e.g.
settings.base.system_name = T("Quick Response Host")
#settings.base.prepopulate = ("default", "default/users")
#settings.base.theme = "default"
#settings.L10n.default_language = "en"
#settings.security.policy = 7 # Organisation-ACLs
# Enable Additional Module(s)
settings.modules["quickresponse"] = Storage(
        name_nice = T("Quick Response Host"),
        #restricted = False,
        module_type = 10,
    )
