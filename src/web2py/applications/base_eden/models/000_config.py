...
# Base settings
settings.base.system_name = T("Disaster Response System for QuickResponseHost")
settings.base.system_name_short = T("DRS-QuickResponseHost")
...
settings.auth.hmac_key = "b2357d2c-b4b2-45fb-8dc1-64a2fbda46e2"
...
# e.g.
settings.base.system_name = T("Disaster Response System")
...
"""
try:
    del settings.modules["transport"]
    del settings.modules["vehicle"]
    del settings.modules["inv"]
    del settings.modules["org"]
    del settings.modules["budget"]
    del settings.modules["member"]
    del settings.modules["org"]
    del settings.modules["supply"]
    del settings.modules["supply"]

except:
    pass
"""
print settings.modules.keys()
